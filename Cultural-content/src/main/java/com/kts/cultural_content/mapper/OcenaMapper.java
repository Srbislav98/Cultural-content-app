...
public class OcenaMapper implements MapperInterface<Ocena, OcenaDTO> {
    ...
    @Override
    public Ocena toEntity(OcenaDTO dto){return new Ocena(dto.getVrednost(),dto.getRegId(),dto.getKulId());}

    @Override
    public OcenaDTO toDto(Ocena entity) {return new OcenaDTO(entity.getId(), entity.getVrednost(),entity.getRegId(),entity.getKulId());}
}
