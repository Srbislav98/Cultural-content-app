...
import com.kts.cultural_content.security.auth.RestAuthenticationEntryPoint;
import com.kts.cultural_content.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/api/lokacije/getById/**").permitAll()
                .antMatchers("/api/kulturnePonude/by-page").permitAll()
                .antMatchers("/api/kulturnePonude/filter-by-grade/**/kulturna/**").permitAll()
                ...
                .antMatchers("/api/kulturnePonude/getSlikaKul/**").permitAll()
