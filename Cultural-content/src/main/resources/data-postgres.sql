...
--NOVOSTI
INSERT into novost(id, datum, naziv, opis, kulturna_ponuda_id) values (100, '2020-12-12', 'Programiranje', 'Jedini programski jezik koji računar može direktno izvršavati je mašinski jezik (mašinski kod ili binarni kod). U počecima računarstva programeri su pisali u mašinskom kodu,', 100)
INSERT into novost(id, datum, naziv, opis, kulturna_ponuda_id) values (101, '2020-12-08', 'Uzorci', 'Prvi korak u izradi računarskog programa je analiza potreba, razmatranje situacije i problem koji treba riješiti definisati preko jednačina, uslova i kroz tzv. pseudo algoritam. ', 100)
INSERT into novost(id, datum, naziv, opis, kulturna_ponuda_id) values (102, '2020-12-08', 'Izvršenje', 'Kada su izvršene sve (analitičke) pripreme i ručno ispisan kod potrebno ga je unijeti u računar prilagođavajući programskom alatu u kojem će se program testirati i izvršavati. ', 100)
INSERT into novost(id, datum, naziv, opis, kulturna_ponuda_id) values (103, '2020-12-11', 'Programiranje', 'Jedini programski jezik koji računar može direktno izvršavati je mašinski jezik (mašinski kod ili binarni kod). U počecima računarstva programeri su pisali u mašinskom kodu, ', 101)
INSERT into novost(id, datum, naziv, opis, kulturna_ponuda_id) values (104, '2020-08-12', 'Primer', 'Primjer prevoditeljskog (interpretiranog) programskog jezika bio bi Basic (izvršava se unutar posebnog programa tzv. prevoditelja (eng. interpreter) koji stoji između  ', 101)
INSERT into novost(id, datum, naziv, opis, kulturna_ponuda_id) values (105, '2020-06-12', 'Takodje', 'Pri programiranju se također koriste razne metodologije razvoja software-a (programske podrške) pri kojima je dobro početi od vodopadnog modela, spiralnog, prototypinga i', 102)
INSERT into novost(id, datum, naziv, opis, kulturna_ponuda_id) values (106, '2020-01-09', 'Postoje', 'Postoje drugi oblici klasifikacija i tipovi programskih jezika od čega je vjerojatno bitno spomenuti objektno-orjentirane jezike (C++, Java, ...) koji su danas najrašireniji u', 102)
INSERT into novost(id, datum, naziv, opis, kulturna_ponuda_id) values (107, '2020-02-03', 'Uput', 'Programiranje je pisanje uputa računalu što i kako učiniti, a izvodi se u nekom od programskih jezika. Programiranje je umjetnost i umijeće u stvaranju programa za računala.', 103)
INSERT into novost(id, datum, naziv, opis, kulturna_ponuda_id) values (108, '2020-04-05', 'Priprema', 'Kada su izvršene sve (analitičke) pripreme i ručno ispisan kod potrebno ga je unijeti u računar prilagođavajući programskom alatu u kojem će se program testirati i ', 103)
INSERT into novost(id, datum, naziv, opis, kulturna_ponuda_id) values (109, '2020-09-09', 'Struktura', 'Razgranata struktura će se pojaviti kod algoritma koji ima blok odlučivanja kao što su IF i CASE, pri čemu se vrši testiranje određenog uslova a prema rezultatu  ', 103)
--RECENZIJE
INSERT into recenzija(id,  komentar, kul_id,ocena,reg_id,kulturna_ponuda_id,registrovani_korisnik_user_id) values (100,'Veoma lose!',101,1,1,101,1)
INSERT into recenzija(id,  komentar, kul_id,ocena,reg_id,kulturna_ponuda_id,registrovani_korisnik_user_id) values (101,'Veoma Interesantan objekat!',100,5,2,100,7)
INSERT into recenzija(id,  komentar, kul_id,ocena,reg_id,kulturna_ponuda_id,registrovani_korisnik_user_id) values (102,'Tamo amo Karakteristika linijske strukture je da se svi elementi izvršavaju samo jednom i koraci se odvijaju u nizu jedan za drugim bez ponavljanja ili "skretanja".',100,3,3,100,3)
INSERT into recenzija(id,  komentar, kul_id,ocena,reg_id,kulturna_ponuda_id,registrovani_korisnik_user_id) values (103,'These might be considered part of the programming process, but often the term software development is used for this larger process with the term programming, implementation, or coding reserved for the actual writing of code.',100,4,4,100,4)
INSERT into recenzija(id,  komentar, kul_id,ocena,reg_id,kulturna_ponuda_id,registrovani_korisnik_user_id) values (104,'Software engineering combines engineering techniques with software development practices. Reverse engineering is a related process used by designers, analysts and programmers to understand and re-create/re-implement.',101,1,5,101,5)
INSERT into recenzija(id,  komentar, kul_id,ocena,reg_id,kulturna_ponuda_id,registrovani_korisnik_user_id) values (105,' Jacquard loom could produce entirely different weaves by changing the "program" – a series of pasteboard cards with holes punched in them.',102,3,6,102,6)
INSERT into recenzija(id,  komentar, kul_id,ocena,reg_id,kulturna_ponuda_id,registrovani_korisnik_user_id) values (106,' Zbog toga su stručnjaci stvorili programske jezike višeg nivoa pomoću kojih se piše izvorni kod koji se u mašinski kod prevodi posredstvom specijalnih programa - prevodilaca čiji je zadatak da prevede kod više',102,2,7,102,7)
INSERT into recenzija(id,  komentar, kul_id,ocena,reg_id,kulturna_ponuda_id,registrovani_korisnik_user_id) values (107,'Veoma dobro!',103,5,1,103,1)
