INSERT into uloga(id, ime) values (100, 'registrovan')
INSERT into tip_kulturne_ponude(id, naziv) values (100,'obicna')
INSERT into registrovani_korisnik(id,email,ime,korisnicko_ime,lozinka,prezime,uloga_id) values (101,'123@','Aca','arak','123','Acic',100)
