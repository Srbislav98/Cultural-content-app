...
public class KorisnikServiceUnitTest {
    ...
    private Korisnik kCreate;//=new Admin(NEW_USER_ID,NEW_USER_NAME,NEW_USER_SURNAME,NEW_USER_USERNAME,NEW_USER_EMAIL,NEW_USER_PASSWORD);
    private Korisnik kExists;
    @Before
    public void setup() {
        kCreate=new Korisnik(9,"Srbislav","Vucenovic","Srbislav1","srbislav@gmail.com","admin");
        kExists=new Korisnik(3,"Aca","Acic","acika","3@gmail.com","user");
